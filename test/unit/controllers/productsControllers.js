...
describe('1.2) PRODUCTS CONTROLLER LAYER - Search for products by id', () => {
  describe('if product do not exists', () => {
    ...
    beforeEach(() => {
      ...
      sinon.stub(productService, 'getProductsById').resolves(resultExecute);
    });
